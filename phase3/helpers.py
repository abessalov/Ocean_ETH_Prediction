# Utilities functions from Ocean: https://github.com/oceanprotocol/predict-eth/blob/main/predict_eth/helpers.py
# Changed: In the create_alice_wallet function we can set the env variable now 
# MY_PRIVATE_KEY1 - for Polygon main
# REMOTE_TEST_PRIVATE_KEY1 - for Mumbai
...
def create_alice_wallet(ocean: Ocean, env = "MY_PRIVATE_KEY1") -> LocalAccount:
    config = ocean.config_dict
    alice_private_key = os.getenv(env)
